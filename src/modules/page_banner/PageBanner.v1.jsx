/**
 * Page Banner - Bootstrap-based layout component
 *
	...
	return (
		<>
			<StyledPageBanner>
				<SingleImageParallax
					src={
						bannerImage?.urls?.large
							? 'https://bestinbd.com' + bannerImage?.urls?.large  : 'https://bestinbd.com' + bannerImage?.full_path || '/images/static/blur.jpg'
					}
					alt={bannerImage?.short_title || 'Page Banner'}
				/>
				<ThemeLayout
					columns={1}
					colSizes={{ xs: 12, md: 10 }}
					colData={[subtitle]}
				/>
			</StyledPageBanner>
...
`;
export default React.memo(PageBannerV1);
